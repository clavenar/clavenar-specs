...
new cluster, anonymously pulls chart `0.38.4`, installs its packaged bundled
values plus `clavenar-images-1.249.4.yaml`, waits for Jobs and workloads, and
...
**Module status:** **release acceptance in progress for v1.249.4.**
