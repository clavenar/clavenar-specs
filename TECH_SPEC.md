...
| 6g | [External install verification](#external-install-verification) | release acceptance in progress | v1.241.2 | `clavenar-specs`, SDK/Lite/CLI/Chart owners, `clavenar-e2e`, `clavenar-website` |
...
**Module status:** **release acceptance in progress for v1.241.2.**
...
new cluster, anonymously pulls chart `0.35.2`, installs its packaged bundled
values plus `clavenar-images-1.241.2.yaml`, waits for hooks and workloads, and
