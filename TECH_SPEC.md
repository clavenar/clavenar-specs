...
new cluster, anonymously pulls chart `1.0.0`, installs its packaged bundled
values plus `clavenar-images-1.250.4.yaml`, waits for Jobs and workloads, and
