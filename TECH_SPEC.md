...
| 6g | [External install verification](#external-install-verification) | release acceptance in progress | v1.241.1 | `clavenar-specs`, SDK/Lite/CLI/Chart owners, `clavenar-e2e`, `clavenar-website` |
...
**Module status:** **release acceptance in progress for v1.241.1.**
...
new cluster, anonymously pulls chart `0.35.1`, installs its packaged bundled
values plus `clavenar-images-1.241.1.yaml`, waits for hooks and workloads, and
