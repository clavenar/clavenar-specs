...
new cluster, anonymously pulls chart `0.38.5`, installs its packaged bundled
values plus `clavenar-images-1.249.5.yaml`, waits for Jobs and workloads, and
...
**Module status:** **release acceptance in progress for v1.249.5.**
